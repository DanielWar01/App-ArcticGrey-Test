...
export type FeaturedCollectionHomePageFragment = Pick<
...
export type FeaturedCollectionHomePageQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;
...
export type RecommendedProductsHomePageQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type RecommendedProductsHomePageQuery = {
  products: {
    nodes: Array<
...
export type GetProductsByTypeQueryVariables = StorefrontAPI.Exact<{
...
export type GetProductsByTypeQuery = {
  products: {
    edges: Array<{
      node: Pick<
        StorefrontAPI.Product,
        'id' | 'title' | 'productType' | 'handle' | 'description' | 'tags'
      > & {
        priceRange: {
          minVariantPrice: Pick<
            StorefrontAPI.MoneyV2,
...
export type RecommendedProductsCartQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type RecommendedProductsCartQuery = {
  products: {
    nodes: Array<
      Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
        priceRange: {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  fragment FeaturedCollectionHomePage on Collection {\n    id\n    title\n    description\n    image {\n      id\n      url\n      altText\n      width\n      height\n    }\n    handle\n  }\n  query FeaturedCollectionHomePage($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    collections(first: 5, sortKey: UPDATED_AT, reverse: true) {\n      nodes {\n        ...FeaturedCollectionHomePage\n      }\n    }\n  }\n': {
    return: FeaturedCollectionHomePageQuery;
    variables: FeaturedCollectionHomePageQueryVariables;
  };
  '#graphql\n  fragment RecommendedProductHomePage on Product {\n    id\n    title\n    handle\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n    images(first: 1) {\n      nodes {\n        id\n        url\n        altText\n        width\n        height\n      }\n    }\n  }\n  query RecommendedProductsHomePage ($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    products(first: 4, sortKey: UPDATED_AT, reverse: true) {\n      nodes {\n        ...RecommendedProductHomePage\n      }\n    }\n  }\n': {
    return: RecommendedProductsHomePageQuery;
    variables: RecommendedProductsHomePageQueryVariables;
  };
  ...
  '#graphql\n  query getProductsByType($productType: String!) {\n    products(first: 4, query: $productType) {\n      edges {\n        node {\n          id\n          title\n          productType\n          handle\n          description\n          priceRange {\n            minVariantPrice {\n              amount\n              currencyCode\n            }\n          }\n          tags\n          images(first: 1) {\n            edges {\n              node {\n                url\n                altText\n              }\n            }\n          }\n          variants(first: 9) {\n            edges {\n              node {\n                ...ProductVariant\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n  \n  fragment ProductVariant on ProductVariant {\n    availableForSale\n    compareAtPrice {\n      amount\n      currencyCode\n    }\n    id\n    image {\n      __typename\n      id\n      url\n      altText\n      width\n      height\n    }\n    price {\n      amount\n      currencyCode\n    }\n    product {\n      title\n      handle\n    }\n    selectedOptions {\n      name\n      value\n    }\n    sku\n    title\n    unitPrice {\n      amount\n      currencyCode\n    }\n  }\n': {
    return: GetProductsByTypeQuery;
    variables: GetProductsByTypeQueryVariables;
  };
  '#graphql\n  query Articles{\n    blog(handle: "news") {\n      title\n      articles(first: 3) {\n        nodes {\n          title\n          handle\n          tags\n          publishedAt\n          seo {\n            title\n            description\n          }\n          image {\n            url\n  \t\t\t\t\twidth\n  \t\t\t\t\theight\n            altText\n          }\n          authorV2 {\n            name\n          }\n        }\n      }\n    }\n  }\n': {
  ...
  '#graphql\n  query RecommendedProductsCart {\n    products(first: 4) {\n      nodes {\n        id\n        title\n        handle\n        priceRange {\n          minVariantPrice {\n            amount\n            currencyCode\n          }\n        }\n        images(first: 1) {\n          nodes {\n            id\n            url\n            altText\n            width\n            height\n          }\n        }\n      }\n    }\n  }\n': {
    return: RecommendedProductsCartQuery;
    variables: RecommendedProductsCartQueryVariables;
  };
